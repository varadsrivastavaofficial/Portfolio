...
export function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor() {
      ...
      // Cycle through rich vibrant gold, electric yellow, and amber tones
      const hue = 0.12 + Math.random() * 0.05; // ~43° to 61° (pure gold / bright yellow)
      const c = HSVtoRGB(hue, 0.95 + Math.random() * 0.05, 1.0);
      c.r *= 0.4;
      c.g *= 0.4;
      c.b *= 0.4;
      return c;
